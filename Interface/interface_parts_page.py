...
from UI.ui_parts_page import Ui_Form as Ui_PartsPage
...
class InterfacePartsPage(QWidget, Ui_PartsPage):
    ...
    def __init__(self, db_operator: DatabaseOperator):
        ...
        self.tableParts.init_table(table_headers=CF_PARTS_TABLE_HEADER)     # 表格标题
    ...
    def fill_in_table(self):
        parts = self.db_operator.get_all_parts_pins_map(demand_list=["Part", "Line"], filter_dict=self.filter_dict)
