...
from UI.Teach.ui_teach_pins_map_page import Ui_Form as Ui_TeachPinsMapPage
...
class InterfaceTeachPinsMapPage(QWidget, Ui_TeachPinsMapPage):
    ...
    def init(self, line: str, location: str, part: str, x_number: int, y_number: int, pins_map: np.ndarray):
        self.line = line
