...
from UI.Root.Page.Socket.ui_socket_page import Ui_Form as Ui_SocketPage
...
class InterfaceSocketPage(QWidget, Ui_SocketPage):
    ...
    def start_listen(self):
        ...
        t = Thread(
            target=self.socket_operator.start_listen,
            kwargs=parameters,
            daemon=True,
        )
        t.start()
    ...
    def server_created_failed(self, error: str):
        ...
        Messenger.show_message_box(widget=self, message=message)
