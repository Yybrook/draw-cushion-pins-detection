...
CF_APP_TITLE = "Pins-Ctrl-RGB"

# CF_README_PATH = r'PinsCtrlData/ReadMe/Pins-Ctrl软件说明书_V3.2.0_20240313.pdf'
# CF_DYNAMIC_CONFIG_PATH = r'PinsCtrlData/Config/DynamicConfig.yaml'
...
# CF_GRAB_SCRIPT_FILE = r"main_grab_rgb.py"
# CF_TEACH_SCRIPT_FILE = r"main_teach.py"
...
# CF_TEACH_VERIFICATION_PAGE = 2
CF_TEACH_COLOR_PAGE = 2
CF_TEACH_DIVISION_PAGE = 3
CF_TEACH_BINARIZATION_PAGE = 6
CF_TEACH_DENOISE_PAGE = 7
CF_TEACH_CONTOURS_PAGE = 8
CF_TEACH_MEAN_PAGE = 4
CF_TEACH_PINS_MAP_PAGE = 5
